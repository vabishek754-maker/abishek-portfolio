          ...
          <div className="relative z-10 flex flex-col-reverse md:flex-row items-start md:items-center justify-between gap-8">
            <div className="flex-1">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-lg font-medium max-w-xl transition-colors duration-500">
                Hi, I'm <span className="text-slate-900 dark:text-white">Abishek V</span>. I specialize in bridging high-performance PHP backend logic with seamless, modern frontend experiences.
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="w-full bg-slate-100 dark:bg-slate-700 rounded-full h-2">
                <div className="bg-blue-600 h-2 rounded-full w-9/12 shadow-[0_0_10px_rgba(37,99,235,0.4)]"></div>
              </div>
            </div>
            <div>
              <div className="flex justify-between mb-2">
              ...
              <div className="w-full bg-slate-100 dark:bg-slate-700 rounded-full h-2">
                <div className="bg-blue-600 h-2 rounded-full w-7/12 shadow-[0_0_10px_rgba(37,99,235,0.4)]"></div>
              </div>
            </div>
          </div>
        </ScrollReveal>
